...
train_dataset = DepthMapDataset('C:/Hatem/nyudepthv2/img_dataset/image/', 'C:/Hatem/nyudepthv2/img_dataset/depth/', transform_img, transform_depth)
train_loader = DataLoader(train_dataset, batch_size=256, shuffle=True, pin_memory=True)

val_dataset = DepthMapDataset('C:/Hatem/nyudepthv2/img_dataset/test/image/', 'C:/Hatem/nyudepthv2/img_dataset/test/depth/', transform_img, transform_depth)
