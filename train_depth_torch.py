...
if __name__ == '__main__':       
    ...
    train_loader = DataLoader(train_dataset, batch_size=96, shuffle=True, num_workers=32, pin_memory= True)
    ...
    val_loader = DataLoader(val_dataset, batch_size=96, shuffle=False, num_workers=32,  pin_memory= True)
